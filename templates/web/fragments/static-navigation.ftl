                ...
                <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse" >
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/catalog" class="nav-item nav-link <#if currentUrl?starts_with("/catalog")>active</#if>">CATALOG</a>
                            <a href="/project" class="nav-item nav-link <#if currentUrl?starts_with("/project")>active</#if>">VISIONE</a>
                        
                            <div class="nav-item dropdown">
                                <a href="/partners-page" class="nav-item nav-link dropdown-toggle <#if currentUrl?starts_with("/partner")>active</#if>">PARTNER <i class="fa fa-angle-down mt-1"></i></a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu  rounded-0 border-0 m-0">
                                    ...
                                    <a href="/finance" class="nav-item nav-link sublink <#if currentUrl?starts_with("/finance")>active</#if>">Access to finance</a>
                                    <a href="/networking" class="nav-item nav-link sublink <#if currentUrl?starts_with("/networking")>active</#if>">Networking & Open innovation</a>
