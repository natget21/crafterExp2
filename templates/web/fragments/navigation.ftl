                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div id="catalog-btn" class="nav-item dropdown">
                                <a href="/catalog" class="nav-item nav-link dropdown-toggle">CATALOGO <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu  rounded-0 border-0 m-0">
                        ...
                        <div id='authenticationBlock1' class="navbar-nav ml-auto py-0">
        ...
        async function loadPartners(container) {
            ...
            if(response.ok) {
                ...
                for(let partner of partners) {
                    ...
                    link.className = "nav-item nav-link sublink py-0 my-1";
