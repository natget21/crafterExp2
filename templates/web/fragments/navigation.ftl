                ...
                <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown" style="box-shadow: none !important; outline: none !important;">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">DASHBOARD <i class="fa fa-angle-down mt-1" style="box-shadow: none !important; outline: none !important;"></i></a>
                                <div class="dropdown-menu  rounded-0 border-0 m-0">
