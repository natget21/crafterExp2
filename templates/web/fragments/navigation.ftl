                            ...
                            <#if categoriesTree?has_content>
                                <#list categoriesTree.childItems as category>
                                    ...
                                    <#assign relatedSubcategories = subCategoriesTree.childItems?filter(subcategory -> 
                                        ...
                                        <a href="/services?category=${categoryItem.('internal-name')?url?default("")}&categoryURL=${categoryItem.queryValue('file-name')?url?default("")}" class="nav-link dropdown-toggle" data-toggle="dropdown">
