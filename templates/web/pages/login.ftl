        ...
        <div class="card-body p-4">
          ...
          <form id="login-form">
            ...
            <div class="text-center mt-2" >
                <span class="text-dark">Password dimenticata?</span>
                <a class="text-primary" href="${passwordRecoverUrl}" target="_blank">clicca qui.</a>
            </div>
    ...
    <script>
        document.getElementById("login-form").addEventListener("submit", async function (event) {
            ...
            fetch('https://api.shortcut.uno/v1/Ideale-client/login', {
                ...
                credentials: 'include',
                body: JSON.stringify({ email, password,"projectId":"68626fe9b307486bc6b5276b" })//67ac9fa58932d32db3c9768e  68626fe9b307486bc6b5276b
            })
