...
<@crafter.body_top/>
    ...
    <iframe id="partnerFrame" src="https://ideale.shortcut.uno/account-login?themeStyle=light&headerTitle=InnovationManager&switchMode=Ok" width="100%" height="750px" frameborder="0"></iframe>
