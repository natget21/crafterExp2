...
<@crafter.body_top/>
    ...
    <iframe id="partnerFrame" src="http://localhost:5000/v1/web/account-login?themeStyle=light&headerTitle=Innovation Manager&switchMode=Ok" width="100%" height="750px" frameborder="0"></iframe>
