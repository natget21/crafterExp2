        ...
        <div class="content pb-5">
          ...
          <div class="banner_section banner_project layout_padding">
            ...
            <div class="container flex-column align-items-end">
              ...
              <p class="there_text d-flex justify-content-end dark p-0 m-0">
          ...
          <!-- Marketing Section -->
          <div class="mx-auto flex-column justify-content-center col-11 col-md-9 px-0">
          ...
          <div class="layout_padding services_section d-flex mx-auto flex-column justify-content-center col-11 col-md-9 px-0">
            ...
            <#if contentModel.descrizioneservizi_t?? && contentModel.descrizioneservizi_t?has_content>
              ...
              <div class="accordion" id="productsAccordion">
                <#list contentModel.prodottidigitali_o.item as item>
                  <div class="accordion-item">
                    ...
                    <div id="${item.databstarget_s}" class="accordion-collapse collapse" data-bs-parent="#productsAccordion">
              ...
              <div class="accordion" id="servicesAccordion">
                <#list contentModel.servizidigitali_o.item as item>
                  <div class="accordion-item">
                    ...
                    <div id="${item.databstarget_s}" class="accordion-collapse collapse" data-bs-parent="#servicesAccordion">
                      <div class="accordion-body">
                        <#if item.descrizione_t?? && item.descrizione_t?has_content>
                          ${item.descrizione_t}
                        </#if>
          ...
          <div class="layout_padding targets_section mx-auto col-11 col-md-9 px-0">
            ...
            <div class="targets row layout_padding pl-3 gap-3">
              <#list contentModel.settoritarget_o.item as item>
                <#assign widthValue = item.stile_s?if_exists?trim>
                <div class="target px-0 col-12 col-md-2 d-flex justify-content-start flex-column gap-3">
                  <#if item.imagepath_s?? && item.imagepath_s?has_content>
                    <div class="imageContainer">
                      <img src="${item.imagepath_s}" alt="" style="width: ${widthValue?has_content?then(widthValue, '70px')}" />
                    </div>
