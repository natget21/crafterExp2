...
<head>
    ...
    <link rel="stylesheet" href="/static-assets/css/skills-training.css" />
        ...
        <div class="col-md-6">
          <ul class="list-group">
            <li class="list-group-item">
              ...
              Corsi di formazione standardizzati che coprono una vasta gamma di
              tematiche, dalle tecnologie digitali avanzate alle competenze
            ...
            <li class="list-group-item">
              ...
              Programmi di formazione personalizzati, progettati per rispondere
              a specifiche esigenze aziendali e tecnologiche. Questi corsi sono
              sviluppati su misura per migliorare le competenze interne in base
              alle sfide e obiettivi specifici dell'azienda.
            </li>
          </ul>
        </div>
      </div>
