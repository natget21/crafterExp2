...
<#assign serviceLink = "/detail?service=${contentModel.queryValue('internal-name')?url}" />
    ...
    <div class="product-item bg-light mb-4">
        <div class="product-img position-relative overflow-hidden">
            <img class="img-fluid w-100" src="${contentModel.image_s?has_content ? contentModel.image_s : '/static-assets/img/default/product-default.png'} alt="${contentModel.name_s?default("")}">
